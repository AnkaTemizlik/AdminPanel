...
namespace DNA.Domain.Services {
    public interface IEmailService {
        ...
        Task<bool> SendAsync(Exception e, IModel model);
        Task<bool> SendAsync(string fullSectionPath, string[] attachments, params MailAddress[] cc);
        Task<bool> SendAsync(string fullSectionPath, string confirmCode, string[] attachments, params MailAddress[] cc);
